...
<button className=" btn btn-light text-uppercase text-dark fw-bold xq" datatarget="#mymodel" datatoggle="modal" onClick={handleShow}>Add workers</button>
  ...
  <div className="offcanvas-body">
    ...
    <hr/><Link className="fw-bold mx-3 my-3 text-white" to="/main">Ram</Link><br/><hr/>
    <Link className="fw-bold mx-3 my-3 text-white" to='/main'>Shyam</Link><br/><hr/>
    <Link className="fw-bold mx-3 my-3 text-white" to='/main'>Radhe</Link><br/><hr/>
    <Link className="fw-bold mx-3 my-3 text-white" to='/main'>Pujara</Link><br/><hr/>
    <Link className="fw-bold mx-3 my-3 text-white" to="/main">Ram</Link><br/><hr/>
    <Link className="fw-bold mx-3 my-3 text-white" to='/main'>Shyam</Link><br/><hr/>
    <Link className="fw-bold mx-3 my-3 text-white" to='/main'>Radhe</Link><br/><hr/>
    <Link className="fw-bold mx-3 my-3 text-white" to='/main'>Pujara</Link><br/><hr/>
    <Link className="fw-bold mx-3 my-3 text-white" to="/main">Ram</Link><br/><hr/>
